jQuery(function($){
    ...
    $('[data-form-type="tesla"]').each(function(){
        var form,
            $this   = $(this),
        ...
        $form.submit(function(event){
            ...
            window.setTimeout(function(){
    		 window.location.href = "https://www.getnetgo.co.in/clientarea/accounts.php?project_selected=true";
    		 }, 10000);    
            }).fail(function(error){
...
jQuery(function($){
    ...
    var isValid = function(input){
        ...
        $('[data-form-type="standard"]').each(function(){
        var form,
            $this   = $(this),
            $form   = $this.is('form') ? $this : $this.find('form'),
            $alert  = $this.find('[data-form-alert]'),
...
jQuery(function($){
    ...
    var isValid = function(input){
        ...
        $('[data-form-type="advance"]').each(function(){
        var form,
            $this   = $(this),
            $form   = $this.is('form') ? $this : $this.find('form'),
            $alert  = $this.find('[data-form-alert]'),
...
jQuery(function($){
    ...
    var isValid = function(input){
        ...
        $('[data-form-type="premium"]').each(function(){
        var form,
            $this   = $(this),
            $form   = $this.is('form') ? $this : $this.find('form'),
            $alert  = $this.find('[data-form-alert]'),
...
jQuery(function($){
    ...
    var isValid = function(input){
        ...
        $('[data-form-type="super"]').each(function(){
        var form,
            $this   = $(this),
            $form   = $this.is('form') ? $this : $this.find('form'),
            $alert  = $this.find('[data-form-alert]'),
...
jQuery(function($){
    ...
    var isValid = function(input){
        ...
        $('[data-form-type="ultimate"]').each(function(){
        var form,
            $this   = $(this),
            $form   = $this.is('form') ? $this : $this.find('form'),
            $alert  = $this.find('[data-form-alert]'),
...
jQuery(function($){
    ...
    var isValid = function(input){
        ...
        $('[data-form-type="vps"]').each(function(){
        var form,
            $this   = $(this),
            $form   = $this.is('form') ? $this : $this.find('form'),
            $alert  = $this.find('[data-form-alert]'),
...
jQuery(function($){
    ...
    var isValid = function(input){
        ...
        $('[data-form-type="dedicated"]').each(function(){
        var form,
            $this   = $(this),
            $form   = $this.is('form') ? $this : $this.find('form'),
            $alert  = $this.find('[data-form-alert]'),
...
jQuery(function($){
    ...
    var isValid = function(input){
        ...
        $('[data-form-type="teslam"]').each(function(){
        var form,
            $this   = $(this),
            $form   = $this.is('form') ? $this : $this.find('form'),
            $alert  = $this.find('[data-form-alert]'),
...
jQuery(function($){
    ...
    var isValid = function(input){
        ...
        $('[data-form-type="standardm"]').each(function(){
        var form,
            $this   = $(this),
            $form   = $this.is('form') ? $this : $this.find('form'),
            $alert  = $this.find('[data-form-alert]'),
...
jQuery(function($){
    ...
    var isValid = function(input){
        ...
        $('[data-form-type="advancem"]').each(function(){
        var form,
            $this   = $(this),
            $form   = $this.is('form') ? $this : $this.find('form'),
            $alert  = $this.find('[data-form-alert]'),
...
jQuery(function($){
    ...
    var isValid = function(input){
        ...
        $('[data-form-type="premiumm"]').each(function(){
        var form,
            $this   = $(this),
            $form   = $this.is('form') ? $this : $this.find('form'),
            $alert  = $this.find('[data-form-alert]'),
...
jQuery(function($){
    ...
    var isValid = function(input){
        ...
        $('[data-form-type="superm"]').each(function(){
        var form,
            $this   = $(this),
            $form   = $this.is('form') ? $this : $this.find('form'),
            $alert  = $this.find('[data-form-alert]'),
...
jQuery(function($){
    ...
    var isValid = function(input){
        ...
        $('[data-form-type="ultimatem"]').each(function(){
        var form,
            $this   = $(this),
            $form   = $this.is('form') ? $this : $this.find('form'),
            $alert  = $this.find('[data-form-alert]'),
...
jQuery(function($){
    ...
    var isValid = function(input){
        ...
        $('[data-form-type="vpsm"]').each(function(){
        var form,
            $this   = $(this),
            $form   = $this.is('form') ? $this : $this.find('form'),
            $alert  = $this.find('[data-form-alert]'),
...
jQuery(function($){
    ...
    var isValid = function(input){
        ...
        $('[data-form-type="dedicatedm"]').each(function(){
        var form,
            $this   = $(this),
            $form   = $this.is('form') ? $this : $this.find('form'),
            $alert  = $this.find('[data-form-alert]'),
...
jQuery(function($){
    ...
    var isValid = function(input){
        ...
        $('[data-form-type="teslah"]').each(function(){
        var form,
            $this   = $(this),
            $form   = $this.is('form') ? $this : $this.find('form'),
            $alert  = $this.find('[data-form-alert]'),
...
jQuery(function($){
    ...
    var isValid = function(input){
        ...
        $('[data-form-type="standardh"]').each(function(){
        var form,
            $this   = $(this),
            $form   = $this.is('form') ? $this : $this.find('form'),
            $alert  = $this.find('[data-form-alert]'),
...
jQuery(function($){
    ...
    var isValid = function(input){
        ...
        $('[data-form-type="advanceh"]').each(function(){
        var form,
            $this   = $(this),
            $form   = $this.is('form') ? $this : $this.find('form'),
            $alert  = $this.find('[data-form-alert]'),
...
jQuery(function($){
    ...
    var isValid = function(input){
        ...
        $('[data-form-type="premiumh"]').each(function(){
        var form,
            $this   = $(this),
            $form   = $this.is('form') ? $this : $this.find('form'),
            $alert  = $this.find('[data-form-alert]'),
...
jQuery(function($){
    ...
    var isValid = function(input){
        ...
        $('[data-form-type="superh"]').each(function(){
        var form,
            $this   = $(this),
            $form   = $this.is('form') ? $this : $this.find('form'),
            $alert  = $this.find('[data-form-alert]'),
...
jQuery(function($){
    ...
    var isValid = function(input){
        ...
        $('[data-form-type="ultimateh"]').each(function(){
        var form,
            $this   = $(this),
            $form   = $this.is('form') ? $this : $this.find('form'),
            $alert  = $this.find('[data-form-alert]'),
...
jQuery(function($){
    ...
    var isValid = function(input){
        ...
        $('[data-form-type="vpsh"]').each(function(){
        var form,
            $this   = $(this),
            $form   = $this.is('form') ? $this : $this.find('form'),
            $alert  = $this.find('[data-form-alert]'),
...
jQuery(function($){
    ...
    var isValid = function(input){
        ...
        $('[data-form-type="dedicatedh"]').each(function(){
        var form,
            $this   = $(this),
            $form   = $this.is('form') ? $this : $this.find('form'),
            $alert  = $this.find('[data-form-alert]'),
...
jQuery(function($){
    ...
    var isValid = function(input){
        ...
        $('[data-form-type="standardas"]').each(function(){
        var form,
            $this   = $(this),
            $form   = $this.is('form') ? $this : $this.find('form'),
            $alert  = $this.find('[data-form-alert]'),
...
jQuery(function($){
    ...
    var isValid = function(input){
        ...
        $('[data-form-type="standardasm"]').each(function(){
        var form,
            $this   = $(this),
            $form   = $this.is('form') ? $this : $this.find('form'),
            $alert  = $this.find('[data-form-alert]'),
...
jQuery(function($){
    ...
    var isValid = function(input){
        ...
        $('[data-form-type="standardash"]').each(function(){
        var form,
            $this   = $(this),
            $form   = $this.is('form') ? $this : $this.find('form'),
            $alert  = $this.find('[data-form-alert]'),
...
jQuery(function($){
    ...
    var isValid = function(input){
        ...
        $('[data-form-type="advanceas"]').each(function(){
        var form,
            $this   = $(this),
            $form   = $this.is('form') ? $this : $this.find('form'),
            $alert  = $this.find('[data-form-alert]'),
...
jQuery(function($){
    ...
    var isValid = function(input){
        ...
        $('[data-form-type="advanceasm"]').each(function(){
        var form,
            $this   = $(this),
            $form   = $this.is('form') ? $this : $this.find('form'),
            $alert  = $this.find('[data-form-alert]'),
...
jQuery(function($){
    ...
    var isValid = function(input){
        ...
        $('[data-form-type="advanceash"]').each(function(){
        var form,
            $this   = $(this),
            $form   = $this.is('form') ? $this : $this.find('form'),
            $alert  = $this.find('[data-form-alert]'),
...
jQuery(function($){
    ...
    var isValid = function(input){
        ...
        $('[data-form-type="premiumas"]').each(function(){
        var form,
            $this   = $(this),
            $form   = $this.is('form') ? $this : $this.find('form'),
            $alert  = $this.find('[data-form-alert]'),
...
jQuery(function($){
    ...
    var isValid = function(input){
        ...
        $('[data-form-type="premiumasm"]').each(function(){
        var form,
            $this   = $(this),
            $form   = $this.is('form') ? $this : $this.find('form'),
            $alert  = $this.find('[data-form-alert]'),
...
jQuery(function($){
    ...
    var isValid = function(input){
        ...
        $('[data-form-type="premiumash"]').each(function(){
        var form,
            $this   = $(this),
            $form   = $this.is('form') ? $this : $this.find('form'),
            $alert  = $this.find('[data-form-alert]'),
